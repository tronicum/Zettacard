...
const MODULE_HUB_STRINGS = {
  de: {
    ...
    noSimYet: "Noch keine Prüfungssimulation",
    topics: "Themen",
    runs: "Prüfen",
    simulation: "Prüfungssimulation",
    training: "Üben ohne Zeitlimit",
    practiceQuiz: "Übungsquiz",
    learn: "Lernen",
    about: "Über dieses Modul",
    questionCount: (n) => `${n} Fragen`,
    close: "Schließen",
    kindLicence: "Staatliche Prüfung",
...
const SIGN_REF_STRINGS = {
  de: {
    ...
    intro: "Alle Verkehrszeichen, die in den Führerschein-Fragen vorkommen, mit Bedeutung - nach Zeichenart gruppiert.",
    close: "← Zurück", empty: "Keine Schilderreferenz verfügbar.",
  },
  en: {
    btn: "📚 Signs", ariaLabel: "Sign reference", title: "Sign reference",
    intro: "Every traffic sign referenced by a Führerschein question, with its meaning - grouped by sign category.",
    close: "← Back", empty: "No sign reference available.",
  },
  bar: {
    btn: "📚 Schilder", ariaLabel: "Schilder-Übersicht", title: "Schilder-Übersicht",
    intro: "Jeds Verkehrszeichen, auf des si a Führerschein-Frag bezieht, mit seiner Bedeutung - nach Schilderkategorie sortiert.",
    close: "← Zruck", empty: "Koa Schilder-Übersicht verfügbar.",
  },
  ro: {
    btn: "📚 Semne", ariaLabel: "Ghid de semne", title: "Ghid de semne",
    intro: "Fiecare semn de circulație menționat într-o întrebare Führerschein, împreună cu semnificația sa - grupate pe categorii de semne.",
  ...
  el: {
    ...
    intro: "Κάθε πινακίδα κυκλοφορίας που αναφέρεται σε ερώτηση του Führerschein, με τη σημασία της - ομαδοποιημένη ανά κατηγορία πινακίδας.",
